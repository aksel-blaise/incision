...
plot(fit.size, type = "regression", reg.type = "RegScore", predictor = log(gdf$size), pch = pch.gps.2, col = col.gps.2)
...
plotAllometry(fit.size, size = gdf$size, logsz = TRUE, method = "CAC", pch = pch.gps.2, col = col.gps.2)
...
plotAllometry(fit.size, size = gdf$size, logsz = TRUE, method = "size.shape", pch = pch.gps.2, col = col.gps.2)
...
plotAllometry(fit.sz.uinc2, size = gdf$size, logsz = TRUE, method = "PredLine", pch = pch.gps.2, col = col.gps.2)
```
