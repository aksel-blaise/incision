...
The experimental sample consisted of seven test tiles that were incised and fired to Cone 06 at the Arrowmont School of Arts and Crafts in Gatlinburg, Tennessee. The tiles were later transported to the National Center for Preservation Technology and Training where they were scanned, then to the Heritage Research Center at Stephen F. Austin State University for analysis.

## Experimental tiles

The clay used for the experimental tiles was Red Stone from Highwater Clays. Each tile was moved to a dry box 15 minutes after the incision was made. The tiles were fired in five stages using an electric kiln:
...
A Keyence VR-5000 optical profilometer was used to capture each three-dimensional image, rendered in the VR Series (VR-3000 G2 Series) Analyzer Software, which were exported to Geomagic Design X, where all landmarks and semilandmarks were applied. 
