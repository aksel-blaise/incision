...
col.gps.inc <- wes_palette("Darjeeling1")[as.factor(inc)]
col.hull <- wes_palette("Darjeeling2", 2)

# plotPCAbyINC
pca.plot1 <- plot(pca, asp = 1,
                  pch = pch.gps.inc,
                  col = col.gps.inc)
                  shapeHulls(pca.plot2, 
                             groups = inc,
                             group.cols = col.hull)
...
col.gps.inc2 <- wes_palette("Darjeeling1")[as.factor(inc2)]
col.hull2 <- wes_palette("Darjeeling2", 4)
