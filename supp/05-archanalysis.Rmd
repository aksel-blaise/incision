...
col.gps <- wes_palette("Cavalcanti1")[as.factor(unit)]
# for county
county <- qdata$county
pch.gps.cty <- c(21:25)[as.factor(county)]
col.gps.cty <- wes_palette("Cavalcanti1")[as.factor(unit)]
